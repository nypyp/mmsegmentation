...
class Bottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5, use_GAM=True):
    ...
    def forward(self, x):
        ...
        if self.use_GAM:
            output = self.cv2(self.se(self.cv1(x)))
        else:
...
class C2f(nn.Module):
    ...
    def __init__(self, c1, c2, n=3, shortcut=True, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(Bottleneck(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1, use_GAM=True) for _ in range(n))
